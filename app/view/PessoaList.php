...
class PessoaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $action_edit_fisica = new TDataGridAction([$this, 'onEdit'], ['id' => '{id}']);
        ...
        $action_edit_juridica = new TDataGridAction([$this, 'onEdit'], ['id' => '{id}']);
        ...
        $this->form = new TQuickForm('form_edit');
        $id_field = new TEntry('id');
        $id_field->setEditable(false);
        $this->form->addQuickField('ID', $id_field);
        $this->form->addQuickField('Nome Completo', new TEntry('nome_completo'));
        $this->form->addQuickField('CPF', new TEntry('cpf'));
        $this->form->addQuickField('E-mail', new TEntry('email'));
        $this->form->addQuickField('Telefone', new TEntry('telefone'));
        $this->form->addQuickAction('Salvar', new TAction([$this, 'onSave']), 'fa:save green');

        // Criação da janela modal
        $this->window = new TWindow('Editar Pessoa');
